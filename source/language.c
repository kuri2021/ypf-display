...
// // 유저 세팅
// const u16 TOP_TEMP_KOR[]      = {0xC0C1,0xD310,0x0020,0xC628,0xB3C4};
// const u16 BOTTOM_TEMP_KOR[]   = {0xD558,0xD310,0x0020,0xC628,0xB3C4};
// const u16 PRESSURE_KOR[]      = {0xC555,0xB825};
// const u16 DELAY_TIME_KOR[]    = {0xC9C0,0xC5F0,0xC2DC,0xAC04};
...
// //로그 & 에러
// const u16 ACTIVE_LOG_KOR[] ={0xD65C, 0xC131, 0x0020, 0xB85C, 0xADF8};
// const u16 ERROR_LOG_KOR[] ={0xC5D0, 0xB7EC, 0x0020, 0xB85C, 0xADF8};
...
// const u16 SENSOR_CAL_KOR[] = {0xC13C,0xC11C,0xBCF4,0xC815};
// const u16 PRESSURE_CAL_KOR[] = {0xC555,0xB825,0xBCF4,0xC815};

const u16 TOP_ENG[] = {0x0054, 0x004F, 0x0050};
const u16 BOT_ENG[] = {0x0042, 0x004F, 0x0054};
const u16 TIME_ENG[] = {0x0054, 0x0049, 0x004D, 0x0045};

const u16 TOP_KOR[] = {0x14C1, 0x2710};
const u16 BOT_KOR[] = {0x2958, 0x2710};
const u16 TIME_KOR[] = {0x1B20, 0x1DC0, 0x16DC, 0x0004};

const u16 USER_SETTING_KOR[]   = {0x1B20,0x1C00,0x0020, 0x1538, 0x2705};                 // 유저 세팅
const u16 INPUT_OUTPUT_TEST_KOR[] = {0x1B85, 0x219C, 0x0C25, 0x0020, 0x254C, 0x16A4, 0x26B8}; // 입출력 테스트
const u16 FACTORY_RESET_KOR[] = {0x00F5, 0x1BA5, 0x0020,0x2108, 0x0230, 0x2A54}; // 공장 초기화
const u16 LOG_ERROR_KOR[]      = {0x0C5C, 0x01F8, 0x0020,0x100F, 0x0020,0x19D0, 0x0BEC}; // 로그 및 에러
const u16 WORK_TIME_KOR[]      = {0x1B91, 0x07D9, 0x0020, 0x16DC, 0x0004}; // 작동 시간
const u16 LANGUAGE_KOR[]       = {0x19B8,0x19B4};                                       // 언어
const u16 COMPANY_KOR[]        = {0x2A8C, 0x14AC, 0x158C, 0x001C};                         // 회사소개
const u16 ENGINEER_MODE_KOR[]  = {0x19D4, 0x1DC0, 0x06C8, 0x19B4,0x0020,0x0EA8, 0x08DC}; // 엔지니어 모드

// 유저 세팅
const u16 TOP_TEMP_KOR[]       = {0x14C1, 0x2710, 0x0020, 0x1A28, 0x07C4};                 // 상판 온도
const u16 BOTTOM_TEMP_KOR[]    = {0x2958, 0x2710, 0x0020, 0x1A28, 0x07C4};                 // 하판 온도
const u16 PRESSURE_KOR[]       = {0x1955,0x0C25};                                       // 압력
const u16 DELAY_TIME_KOR[]     = {0x1DC0, 0x19F0, 0x0020, 0x16DC, 0x0004};                         // 딜레이시간

// IO 테스트
const u16 TOP_HEATER_KOR[]     = {0x14C1, 0x2710, 0x0020, 0x2B88, 0x2530};                 // 상판 히터
const u16 BOTTOM_HEATER_KOR[]  = {0x2958, 0x2710, 0x0020, 0x2B88, 0x2530};                 // 하판 히터
const u16 TOP_FAN_KOR[]        = {0x14C1, 0x2710, 0x0020, 0x272C};                         // 상판 팬
const u16 BOTTOM_FAN_KOR[]     = {0x2958, 0x2710, 0x0020, 0x272C};                         // 하판 팬
const u16 COMPRESSOR_KOR[]     = {0x2364, 0x2904, 0x0C08, 0x1554};                         // 컴프레서
const u16 SOLENOID_KOR[]       = {0x1594, 0x0C08, 0x0578, 0x1B74, 0x08DC};                 // 솔레노이드


// 공장 초기화
const u16 INIT_QUESTION1[] = {0x0770, 0x1B74, 0x2530, 0x0D7C}; // 데이터를
const u16 INIT_QUESTION2[] = {0x2108, 0x0230, 0x2A54, 0x2958, 0x16DC, 0x00A0, 0x16B5, 0x06C8, 0x024C}; // 초기화하시겠습니까
const u16 OK_KOR[] = {0x2A55, 0x1B78}; // 확인
const u16 CANCEL_KOR[] = {0x21E8, 0x158C}; // 취소

// 로그 & 에러
const u16 ACTIVE_LOG_KOR[] = {0x1B91, 0x07D9, 0x0020, 0x0C5C, 0x01F8}; // 작동 로그
const u16 ERROR_LOG_KOR[] = {0x19D0, 0x0BEC, 0x0020,0x0C5C, 0x01F8}; // 에러 로그

// 작동 시간
const u16 HEATING_TIME_KOR[] = {0x2B88, 0x2530}; // 가열시간
const u16 FAN_KOR[] = {0x272C}; // 팬
const u16 PUMP_KOR[] = {0x278C, 0x2904}; // 펌프

// 언어
const u16 ENGLISH_KOR[] = {0x1A01, 0x19B4}; // 영어
const u16 KOREAN_KOR[] = {0x295C, 0x016D, 0x19B4}; // 한국어

// 회사 소개
const u16 YONGLI_KOREA_KOR[] = {0x1AA9, 0x0DAC, 0x2354, 0x0DAC, 0x1944}; // 용리코리아
const u16 GYEONGGI_DO_KOR[] = {0x00BD, 0x0230, 0x07C4}; // 경기도
const u16 PAJU_JORI_EUP_KOR[] = {0x270C, 0x1CFC, 0x16DC, 0x0020, 0x1C70, 0x0DAC, 0x1B4D}; // 파주시 조리읍
const u16 DANGJAEBONG_RO_29_KOR[] = {0x06F9, 0x1BAC, 0x1109, 0x0C5C}; // 당재봉로
const u16 NUM_29[] = {0x0032, 0x0039}; //29

// 보정
const u16 SENSOR_CAL_KOR[] = {0x153C, 0x151C, 0x0020, 0x10F4, 0x1C15}; // 센서보정
const u16 PRESSURE_CAL_KOR[] = {0x1955, 0x0C25, 0x0020, 0x10F4, 0x1C15}; // 압력보정
...
//어드민 리스트
const u16 USER_SETTING_ENG[] = {0x0055,0x0053,0x0045,0x0052,0x0020,0x0053,0x0045,0x0054};// User Setting
...
const u16 DATA_INIT_ENG[] = {0x0046,0x0041,0x0043,0x0020,0x0052,0x0045,0x0053,0x0045,0x0054};
...
const u16 COMPANY_INFO_ENG[] = {0x0043,0x004F,0x004D,0x0050,0x0020,0x0044,0x0041,0x0054,0x0041};// Company Info
const u16 ENGINEER_MODE_ENG[] = {0x0045,0x004E,0x0047,0x0020,0x004D,0x004F,0x0044,0x0045};// Engineer Mode

//유저세팅
const u16 TOP_TEMP_ENG[] = {0x0054,0x0020,0x0054,0x0045,0x004D,0x0050};// Top Temp
const u16 BOT_TEMP_ENG[] = {0x0042, 0x0020,0x0054, 0x0045, 0x004D, 0x0050};
const u16 PRESSURE_ENG[] = {0x0050,0x0052,0x0045,0x0053,0x0053,0x0055,0x0052,0x0045};// Pressure
const u16 DELAY_TIME_ENG[] = {0x0044,0x0045,0x004C,0x0041,0x0059};// Delay Time

//IO 테스트
const u16 TOP_HEATER_ENG[] = {0x0054,0x0020,0x0048,0x0054,0x0052};// Top Heater
const u16 BOT_HEATER_ENG[] = {0x0042,0x0020,0x0048,0x0054,0x0052};// Bottom Heater
const u16 TOP_FAN_ENG[] = {0x0054,0x0020,0x0046,0x0041,0x004E};// Top Fan
const u16 BOT_FAN_ENG[] = {0x0042,0x0020,0x0046,0x0041,0x004E};// Bottom Fan
const u16 COMPRESSOR_ENG[] = {0x0043,0x004F,0x004D,0x0050,0x0052,0x0045,0x0053,0x0053,0x004F,0x0052};// Compressor
const u16 SOLENOID_ENG[] = {0x0053,0x004F,0x004C};// Solenoid
...
const u16 ACTIVE_LOG_ENG[] = {0x0041,0x0043,0x0054,0x0049,0x0056,0x0045};// Active Log
const u16 ERROR_LOG_ENG[] = {0x0045,0x0052,0x0052,0x004F,0x0052};// Error Log
//작업 시간
const u16 HEATING_ENG[] = {0x0048,0x0045,0x0041,0x0054};
const u16 PUMP_ENG[] = {0x0050, 0x0055, 0x004D, 0x0050};
const u16 FAN_ENG[] = {0x0046, 0x0041, 0x004E};
...
const u16 DANGJAEBONG_RO_29_ENG[] = {0x0044, 0x0061, 0x006E, 0x0067,0x006A, 0x0061, 0x0065, 0x0062,0x006F, 0x006E, 0x0067, 0x002D,0x0072, 0x006F}; //Dangjaebong-ro29 
...
const u16 SENSOR_CAL_ENG[] = {0x0053, 0x0065, 0x006E, 0x0073, 0x002E, 0x0043, 0x0061, 0x006C, 0x002E};

const u16 PRESSURE_CAL_ENG[] = {0x0050,0x0052,0x0045,0x0053, 0x002E, 0x0043, 0x0061, 0x006C, 0x002E};
...
const u16 TEL[]             = {0x0030,0x0033,0x0031,0x002D,0x0039,0x0035,0x0033,0x002D,0x0034,0x0030,0x0036,0x0033}; // 031-953-4063

const u16 ON_TEXT[] = {0x004F,0x004E};
const u16 OFF_TEXT[] = {0x004F, 0x0046, 0x0046};

const u16 SENSOR_CAL_CHN[] = {
0x4F20,0x611F,0x5668,0x6821,0x51C6
};

const u16 PRESSURE_CAL_CHN[] = {
0x538B,0x529B,0x6821,0x51C6
};

const u16 EXIT_ENG[] = {
    0x0045, 0x0058, 0x0049, 0x0054
};
