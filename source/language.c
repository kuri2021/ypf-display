...
//IO 테스트
const u16 TOP_HEATER_ENG[] = {0x0054,0x0020,0x0048,0x0045,0x0041,0x0054,0x0045,0x0052};// Top Heater
const u16 BOT_HEATER_ENG[] = {0x0042, 0x0020,0x0048,0x0045,0x0041,0x0054,0x0045,0x0052};// Bottom Heater
const u16 TOP_FAN_ENG[] = {0x0054,0x004F,0x0050,0x0020,0x0046,0x0041,0x004E};// Top Fan
const u16 BOT_FAN_ENG[] = {0x0042,0x004F,0x0054,0x0020,0x0046,0x0041,0x004E};// Bottom Fan
