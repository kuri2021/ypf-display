...
const u16 USER_SETTING_KOR[]   = {0x1B20,0x1C00,0x0020,0x1438,0x2705};                 // 유저 세팅
const u16 CHECK_KOR[]          = {0x0049,0x004F,0x0020,0x25CC,0x16A4,0x16B8};         // IO 테스트
const u16 FACTORY_RESET_KOR[]  = {0x00F5,0x1BA0,0x0020,0x1E08,0x1900,0x2954};         // 공장 초기화
const u16 LOG_ERROR_KOR[]      = {0x0C50,0x19F8,0x0020,0x0026,0x0020,0x39D0,0x0B6C}; // 로그 & 에러
const u16 WORK_TIME_KOR[]      = {0x0D11,0x07D9,0x0020,0x0BDC,0x00AC};                 // 작업 시간
const u16 LANGUAGE_KOR[]       = {0x19B8,0x19B4};                                       // 언어
const u16 COMPANY_KOR[]        = {0x2A8C,0x1590,0x15C0,0x001C};                         // 회사소개
const u16 ENGINEER_MODE_KOR[]  = {0x39D4,0x1DC0,0x06C8,0x19B4,0x0020,0x0EA8,0x08E8}; // 엔지니어 모드

// 유저 세팅
const u16 TOP_TEMP_KOR[]       = {0x14C1,0x2531,0x0020,0x1C28,0x06C4};                 // 상판 온도
const u16 BOTTOM_TEMP_KOR[]    = {0x0C58,0x2531,0x0020,0x1C28,0x06C4};                 // 하판 온도
const u16 PRESSURE_KOR[]       = {0x1955,0x0C25};                                       // 압력
const u16 DELAY_TIME_KOR[]     = {0x1DF0,0x19F0,0x16DC,0x00AC};                         // 딜레이시간

// IO 테스트
const u16 TOP_HEATER_KOR[]     = {0x14C1,0x2531,0x0020,0x2C30,0x0430};                 // 상판 히터
const u16 BOTTOM_HEATER_KOR[]  = {0x0C58,0x2531,0x0020,0x2C30,0x0430};                 // 하판 히터
const u16 TOP_FAN_KOR[]        = {0x14C1,0x2531,0x0020,0x283C};                         // 상판 팬
const u16 BOTTOM_FAN_KOR[]     = {0x0C58,0x2531,0x0020,0x283C};                         // 하판 팬
const u16 COMPRESSOR_KOR[]     = {0x23E4,0x2934,0x0C48,0x14E4};                         // 컴프레서
const u16 SOLENOID_KOR[]       = {0x1594,0x2934,0x0571,0x1D74,0x08DC};                 // 솔레노이드


// 공장 초기화
const u16 INIT_QUESTION1[] = {0x06B8,0x15F4,0x2430,0x15F4,0x2430,0x0D4C}; // 데이터를
const u16 INIT_QUESTION2[] = {0x1E08,0x1900,0x2954,0x2C58,0x16DC,0x18A0,0x16B5,0x06C8,0x1A4C}; // 초기화하시겠습니까
const u16 OK_KOR[] = {0x2994,0x1C78}; // 확인
const u16 CANCEL_KOR[] = {0x21F8,0x15C0}; // 취소


// 로그 & 에러
const u16 ACTIVE_LOG_KOR[] = {0x3953,0x1531,0x0020,0x0C50,0x19F8}; // 활성 로그
const u16 ERROR_LOG_KOR[] = {0x39D0,0x0B6C,0x0020,0x0C50,0x19F8}; // 에러 로그


// 기타
const u16 HEATING_TIME_KOR[] = {0x1C00,0x19F0,0x16DC,0x00AC}; // 가열시간
const u16 FAN_KOR[] = {0x283C}; // 팬


// 언어
const u16 ENGLISH_KOR[] = {0x1584,0x19B8}; // 영어
const u16 CHINESE_KOR[] = {0x1511,0x196D,0x19B8}; // 중국어
const u16 KOREAN_KOR[] = {0x295C,0x196D,0x19B8}; // 한국어


// 회사 소개
const u16 YONGLI_KOREA_KOR[] = {0x1AA9,0x0D6C,0x2344,0x0D6C,0x2544}; // 용리코리아
const u16 GYEONGGI_DO_KOR[] = {0x10FD,0x1960,0x07C4}; // 경기도
const u16 PAJU_JORI_EUP_KOR[] = {0x243C,0x1CFC,0x1DC0,0x0020,0x1C90,0x0D6C,0x1B4D}; // 파주시 조리읍
const u16 DANGJAEBONG_RO_29_KOR[] = {0x06F9,0x1BAC,0x11C9,0x0C50,0x0020,0x0032,0x0039}; // 당재봉로 29
const u16 TEL_KOR[] = {0x0030,0x0033,0x0031,0x002D,0x0039,0x0035,0x0033,0x002D,0x0034,0x0030,0x0036,0x0033}; // 031-953-4063


// 보정
const u16 SENSOR_CAL_KOR[] = {0x15CC,0x15CC,0x10F4,0x0C15}; // 센서보정
const u16 PRESSURE_CAL_KOR[] = {0x1955,0x0C25,0x10F4,0x0C15}; // 압력보정
...
const u16 SENSOR_CAL_ENG[] = {
0x0053,0x0045,0x004E,0x0053,0x004F,0x0052,
0x0020,
0x0043,0x0041,0x004C,0x0049,0x0042,0x0052,
0x0041,0x0054,0x0049,0x004F,0x004E
};

const u16 PRESSURE_CAL_ENG[] = {
0x0050,0x0052,0x0045,0x0053,0x0053,0x0055,
0x0052,0x0045,
0x0020,
0x0043,0x0041,0x004C,0x0049,0x0042,0x0052,
0x0041,0x0054,0x0049,0x004F,0x004E
